# -*- coding: utf-8 -*-
"""
Created on Sun Jan 28 13:11:38 2024
...
columns = ['precipitation_day_0','Pa','aspect_FR', 'DEM_FR', 'GPM_FR',
'lithology_FR', 'NDVI_FR', 'plants_FR', 'slope_FR', 'soil_FR']
data = data.dropna()
...
# 获取各模型最优参数
xgb_best_params = {'colsample_bytree': 0.9642944615851877,
 'gamma': 0.8181625017877356,
 'learning_rate': 0.2763091467455219,
 'max_depth': 18,
 'min_child_weight': 2.242040028733469,
 'n_estimators': 182,
 'subsample': 0.8624533757801005}
...
# 文件夹路径
folder_path = 'D:/ei_lanslide/factors_FR/'

# 获取文件夹下所有tif文件
tif_files = [file for file in os.listdir(folder_path) if file.endswith('lon.tif')]
...
df_nc.to_netcdf(r'D:/ei_lanslide/result/rf_FR.nc')
...
df_nc.to_netcdf(r'D:/ei_lanslide/result/lr_FR.nc')